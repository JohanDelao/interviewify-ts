...
function ThirdContent() {
  return (
    <div className="ThirdContent mt-10 mb-10 pb-10">
      <div className="md:max-w-5xl w-[95%] lg:w-full flex flex-col-reverse gap-5 md:grid md:grid-cols-12 mx-auto mt-10 mb-10">
...
function Footer() {
  return (
    <div className="flex md:max-w-5xl w-[95%] mx-auto lg:w-full items-center mb-5">
      <div className='flex w-full flex-col gap-4'>
        <div className='flex flex-col'>
          ...
          <p className='text-sm text-[#434343] pl-1'>Master the behavioral interview</p>
        </div>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex gap-4 items-center justify-around'>
            <div className="w-10 h-10 rounded-full bg-[#F5F5F5] flex justify-center items-center">
              <GithubFilled className="text-black text-2xl leading-none" />
            </div>
            <div className="w-10 h-10 rounded-full bg-[#F5F5F5] flex justify-center items-center">
              <LinkedinFilled className="text-black text-2xl leading-none" />
            </div>
          </div>
        </div>
      </div>
